    ...
    public partial class t : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Olaf", "Kurgeberg", "Bonez MC" },
                    { 2, "Anna", "Dabrowska", "Anna Dabrowska" }
                });

            migrationBuilder.InsertData(
                table: "Albums",
                columns: new[] { "IdAlbum", "AlbumName", "IdMusicLabel", "PublishDate" },
                values: new object[] { 2, "Kwiaty", 1, new DateTime(2022, 6, 9, 11, 43, 25, 527, DateTimeKind.Local).AddTicks(2482) });

            migrationBuilder.InsertData(
                table: "Albums",
                columns: new[] { "IdAlbum", "AlbumName", "IdMusicLabel", "PublishDate" },
                values: new object[] { 1, "187", 2, new DateTime(2022, 6, 9, 11, 43, 25, 525, DateTimeKind.Local).AddTicks(3577) });

            migrationBuilder.InsertData(
                table: "Tracks",
                columns: new[] { "IdTrack", "Duration", "IdMusicAlbum", "TrackName" },
                values: new object[] { 2, 3.5f, 2, "Nigdy wiecej nie tancz ze mna" });

            migrationBuilder.InsertData(
                table: "Tracks",
                columns: new[] { "IdTrack", "Duration", "IdMusicAlbum", "TrackName" },
                values: new object[] { 1, 3.5f, 1, "Kontrollieren" });
